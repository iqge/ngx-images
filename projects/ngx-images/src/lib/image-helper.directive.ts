...
import { NgxImagesService, ImageConfig } from './image-helper.service';


@Directive({
  selector: '[ngxImages]'
})
export class NgxImagesDirective implements OnInit, AfterViewInit {
  ...
  constructor
    ...
    private global: NgxImagesService
    ) {
  }
  ...
  onError() {
    console.log(this.el);
    this.el.nativeElement.src = this.localConfig &&
        this.localConfig.imageFallbackPath ? this.localConfig.imageFallbackPath : this.globalConfig.imageFallbackPath;
